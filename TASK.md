...
- README.md - Documentar seu processo de otimização. Precisa conter:
  - Tabela com variaveis de ambiente
  - Instrucoes de uso
  - Requisitos de software e configuracao
  - Fluxograma em mermaid
  - Documentacao sobre a arquitetura implementada
  - Estrutura do projeto
  - Features
  - Objetivos
- CLAUDE.md - Arquivo de informações relevantes ao projeto, codigo e arquitetura implementada
- AGENTS.md - Arquivo de instruções relevantes a IA para manutenabilidade do codigo
...
- O arquivo README.md tambem deve conter:
